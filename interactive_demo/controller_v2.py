...
class InteractiveController_v2:
    def __init__(self, net, xcoords, ycoords, pos, device, predictor_params, update_image_callback, prob_thresh=0.5):
    ...
    def set_image(self, image):
        ...
        self.add_click(self.xcoords, self.ycoords, self.pos)
        # self.update_image_callback(reset_canvas=True)

    def add_click(self, x, y, is_positive):
        for z in range(len(is_positive)):
            tmp_bool = is_positive[z] == 1
            ...
            click = clicker.Click(is_positive=tmp_bool, coords=(y[z], x[z]))
    ...
    def reset_predictor(self, predictor_params=None):
        ...
        if self.image_nd is not None:
            self.predictor.set_input_image(self.image_nd)  # IMPORTANT
