import mxnet as mx
from gluoncv.model_zoo.resnetv1b import resnet34_v1b, resnet50_v1s, resnet101_v1s, resnet152_v1s
from .resnext_dilated import se_resnext50_32x4d
    ...
    def __init__(self, backbone='resnet50', pretrained_base=True, dilated=True, **kwargs):
        ...
        with self.name_scope():
            if backbone == 'resnet34':
                ...
                pretrained = se_resnext50_32x4d(pretrained=pretrained_base, dilated=dilated, **kwargs)
            else:
